...
namespace DsPhysics
{
	...
	struct DsRigidSpherePhysicsInfo
	{
		DsMass	mass;
		double massInv[10];
		DsMat33d rotation;
	...
	class DsRigidSphere : public DsActor
	{
	public:
		/////////////Factory////////////
	...
	private:
		DsRigidSphereGeometryInfo m_geomInfo;
		DsRigidSpherePhysicsInfo	m_physicsInfo;
		bool m_IsInit;
		DsVec3d m_addPos;
		DsMat33d m_addRot;
		DsVec3d m_initPos;
