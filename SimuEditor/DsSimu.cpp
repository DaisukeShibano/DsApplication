...
void TestMainLoop::Initialize(DsMainLoopArgs& args)
{
	...
	if (isSuccessSetUp)
	{
		...
		if (pWorld)
		{
			...
			//{//箱１
			//	DsRigidBodyCube::DsRigidBodyFactory factory(vertex, 1.0, "箱１");
			//	factory.InitPos(DsVec3d(1.2, yOffset + 4.0, zOffset));
			//	factory.InitRot(DsMat33d::RotateX(1.0));
			//	pWorld->CreateActor(factory);
			//}
			//{//箱２
			//	DsRigidBodyCube::DsRigidBodyFactory factory(vertex, 1.0, "箱２");
			...
			//{
			//	DsVec3d v[8];
			//	DsRigidBodyCube::GetVertex(v, 0.5, 0.5, 0.5);
			//	DsRigidBodyCube::DsRigidBodyFactory factory(v, 1.0, "箱３達");
			...
			//{//地面
			//	DsVec3d vertex[8];
			//	DsRigidBodyCube::GetVertex(vertex, 100.0, 0.5, 100.0);
			//	DsRigidBodyCube::DsRigidBodyFactory factory(vertex, 1.0, "ground");
