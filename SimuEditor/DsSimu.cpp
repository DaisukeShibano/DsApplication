...
void TestMainLoop::Initialize(DsMainLoopArgs& args)
{
	...
	if (isSuccessSetUp)
	{
		...
		if (pWorld)
		{
			...
			//	DsRigidCube::DsRigidBodyFactory factory(v, 1.0, "箱３達");
