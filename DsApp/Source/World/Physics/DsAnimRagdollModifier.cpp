...
//virtual
void DsAnimRagdollModifier::ModifyAnim(double dt, const DsKeyframeAnim& anim, DsVec3d worldPos, DsMat33d worldRot, DsAnimSkeleton& skeleton)
{
	//キーフレームアニメでスケルトンを変更
	UtilKeyframeAnim(dt, anim, skeleton);
